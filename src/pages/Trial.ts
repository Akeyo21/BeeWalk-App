...
*
**/
export function cSnapToRoute(this: any) {
    ...
    **/
    this.loadRouteData = function () {
        ...
        /*Change made to ensure that an undefined value is not read
        */
        this._oMap.addListener('projection_changed', () => {  
            proj = this._oMap.getProjection();
    ...
    *   @return new GLatLng();
    **/
    this.getClosestLatLng = function (latlng: any) {
    ...
    **/
    this.getDistAlongRoute = function (latlng: any) {
        var r = this.distanceToLines(latlng);
    ...
    **/
    this.distanceToLines = function (thisLatLng: any) {
        var tm = this._oMap;
        var proj = this._oMap.getProjection();
    ...
    **/
    this.getDistToLine = function (iLine: number, fTo: number) {
...
function getClosestPointOnLines(pXy: { x: number; y: number; }, aXys: string | any[]) {
